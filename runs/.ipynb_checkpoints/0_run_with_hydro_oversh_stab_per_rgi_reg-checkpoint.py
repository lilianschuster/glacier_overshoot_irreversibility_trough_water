...
for scenario in scenarios:
    if not run_steady_state:
        ...
        utils.compile_run_output(gdirs, input_filesuffix=f'_steady_state_random_run_2399_2499{rid_output}', 
                            path=os.path.join(eq_dir, f'run_random_climate_from2500_using2399_2499{rid_output}_rgi{rgi_reg}_{id0}_{id1}.nc'))
